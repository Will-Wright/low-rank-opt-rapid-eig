function [] = noiselessrandom_refinement_comparison_feas()
% experiments.table.noiselessrandom_refinement_comparison_feas
%
...
pathName = 'cache/table_noiselessrandom_refinement_comparison_feas/';
if exist(pathName) ~= 7
   mkdir(pathName);
end
   ...
   if exist(matFile, 'file') ~= 2
      [results_saga_noiseless_10_128] ...
         = experiments.evolvingmatricespl('L', 10, 'n', 128, ...
                                          ...
                                          'printRelErr', true, ...
                                          'skipPFD', false, 'skipDFP', false, 'StopOnFeasible', true, ...
   ...
   if exist(matFile, 'file') ~= 2
      [results_saga_noiseless_10_128_noDFP] ...
         = experiments.evolvingmatricespl('L', 10, 'n', 128, ...
                                             ...
                                             'verbosity', 1, 'logIterData', true, ...
                                             'printRelErr', true, ...
                                             'skipPFD', false, 'skipDFP', true, 'StopOnFeasible', true, ...
                                             'returnEigsIterData', true, ...
                                             'feaTol', 1e-5, 'optTol', 1e-5, ...
                                             'StopOnRelErr', false);
   ...
   if exist(matFile, 'file') ~= 2
      [results_saga_noiseless_10_128_noPFD] ...
         = experiments.evolvingmatricespl('L', 10, 'n', 128, ...
                                             ...
                                             'verbosity', 1, 'logIterData', true, ...
                                             'printRelErr', true, ...
                                             'skipPFD', true, 'skipDFP', false, 'StopOnFeasible', true, ...
                                             'returnEigsIterData', true, ...
                                             'feaTol', 1e-5, 'optTol', 1e-5, ...
                                             'StopOnRelErr', false);
   ...
   if exist(matFile, 'file') ~= 2
      [results_saga_noiseless_10_128_noPFD_noDFP] ...
         = experiments.evolvingmatricespl('L', 10, 'n', 128, ...
                                          ...
                                          'verbosity', 1, 'logIterData', true, ...
                                          'printRelErr', true, ...
                                          'skipPFD', true, 'skipDFP', true, 'StopOnFeasible', true, ...
                                          'returnEigsIterData', true, ...
                                          'feaTol', 1e-5, 'optTol', 1e-5, ...
                                          'StopOnRelErr', false);
...
if exist(dataFile, 'file') ~= 2
   ...
   save(dataFile, 'data_noiseless_10_128');
   ...
   load(dataFile, 'data_noiseless_10_128');
end
...
fprintf('\nRefinement comparison results with only feasibility required\n');
