...
%EXPERIMENTS.NOISELESSPL  Noiseless PhaseLift experiments.
ip = inputParser;
...
% Additional opts to guarantee behavior of original saga_sd implementation
solverOpts.differentiableObjTol = 0;
solverOpts.StopOnRelErr = false;

% Opts for noiseless models
...
%for i=1:nzip
   ...
   genOpts = struct('n', n, 'L', L, 'noise_ratio', epsilon, 'seed', seed,...
