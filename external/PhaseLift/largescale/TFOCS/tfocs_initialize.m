...
if countOps,
    apply_smooth = @(x)solver_apply( 1:(1+(nOut>1)), smoothF, x );
else
...
if countOps,
    apply_projector = @(varargin)solver_apply( 4:(4+(nOut>1)), projectorF, varargin{:} );
else
